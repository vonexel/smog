...
-----------------
📁 **smog/**  
├─ 📁 **assets/** — вспомогательные файлы для запуска (тексты и конфигурации для тестов).  
│  ├─ 📄 paper_texts.txt  
│  ├─ 📄 paper_edits.csv  
│  └─ 📄 paper_interps.csv  
├─ 📁 **data/** — данные и скрипты для их обработки.  
│  └─ 📁 amass_db/ — обработанные данные AMASS.
...
│  ├─ 📁 datasets/ — скрипты для обработки и загрузки данных.  
│  │  ├─ 🐍 amass.py 
│  │  ├─ 🐍 amass_parser.py 
│  │  ├─ 🐍 dataset.py  
│  │  ├─ 🐍 get_dataset.py 
...
│  ├─ 📁 train/ — .  
│  │  ├─ 🐍 __init__.py  
│  │  ├─ 🐍 duration_finetunning.py 
│  │  ├─ 🐍 train.py  
│  │  └─ 🐍 trainer.py
│  ├─ 📁 utils/ — вспомогательные функции (например, классификация действий).  
│  │  ├─ 🐍 __init__.py 
│  │  ├─ 🐍 action_classifier.py 
│  │  ├─ 🐍 action_label_to_idx.py  
│  │  ├─ 🐍 demo.py 
│  │  ├─ 🐍 fixseed.py  
...
│  │  ├─ 🐍 __init__.py 
│  │  ├─ 🐍 anim.py  
│  │  ├─ 🐍 motion_editing.py — редактирование движения.
│  │  ├─ 🐍 motion_interpolation.py — интерполяция движений. 
│  │  ├─ 🐍 text2motion.py — генерация движения по тексту.
│  │  └─ 🐍 visualize.py
│  ├─ 🐍 __init__.py — .
│  └─ 🐍 config.py
├─ 📁 **visuals/** — изображения.
